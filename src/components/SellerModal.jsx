  ...
  return (
    <dialog id="seller-modal" className="modal modal-bottom sm:modal-middle">
      <div className="modal-box max-w-md text-center p-8 space-y-6">
        {/* Header */}
        <h3 className="text-2xl font-bold text-amber-500">Seller Information</h3>

        {/* Avatar */}
        <div className="flex justify-center">
          <div className="avatar">
            <div className="w-28 h-28 rounded-full ring ring-amber-500 ring-offset-base-100 ring-offset-2 overflow-hidden">
        ...
        <div className="modal-action justify-center">
          <form method="dialog">
            <button className="btn btn-primary bg-amber-500 border-0 text-white w-full sm:w-auto">Close</button>
          </form>
        </div>
